class Solution:
    def checkInclusion(self, s1: str, s2: str) -> bool:
        # Brute
        '''
        Note - actual brute force would be to find every permutation of s1 and just match in s2,
        but that is of complexity O(n!) which is exponential and not doable
