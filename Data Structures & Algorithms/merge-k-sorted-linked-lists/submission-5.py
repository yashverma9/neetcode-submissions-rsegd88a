...
class Solution: 
    ...
    def mergeKLists(self, lists: List[Optional[ListNode]]) -> Optional[ListNode]:
        ...
        # N is the total nodes in all lists, its NlogK because we process all N nodes at each level and we have logk levels
        '''
        We keep halving the lists by sorting pairs till we are left with only 1 list (result)
        '''
